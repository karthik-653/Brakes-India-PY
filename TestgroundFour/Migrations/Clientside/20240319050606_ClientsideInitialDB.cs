...
{
    /// <inheritdoc />
    public partial class ClientsideInitialDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_clientdatas", x => new { x.Plant, x.Unit, x.Celltype, x.Cellno, x.Model, x.Docno, x.Process, x.Pyorder, x.Pyno, x.Date });
                });
        }
